            ...
            <div class="mt-4 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="bg-white overflow-hidden shadow rounded-lg">
                    ...
                    <div class="bg-gray-50 px-5 py-3">
                        <div class="text-sm">
                            <a href="{{ route('admin.pending-users') }}" class="font-medium text-indigo-600 hover:text-indigo-900">
                                View all pending users &rarr;
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow rounded-lg">
                    ...
                    <div class="bg-gray-50 px-5 py-3">
                        <div class="text-sm">
                            <a href="{{ route('admin.users') }}" class="font-medium text-indigo-600 hover:text-indigo-900">
                                View all users &rarr;
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="flex items-baseline">
                                        ...
                                        <p class="ml-2 text-sm text-gray-500">last 7 days</p>
                                    </dd>
                                </dl>
                            </div>
                        </div>
