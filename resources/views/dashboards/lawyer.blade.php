<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            @if((auth()->user()->lawyerProfile && !auth()->user()->lawyerProfile->is_optimized) || 
                (auth()->user()->lawFirmLawyer && !auth()->user()->lawFirmLawyer->is_optimized))
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-yellow-700">
                                You have not optimized your profile for clients. Go to your profile to optimize it and show clients your experience!
                            </p>
                            <div class="mt-4">
                                <a href="{{ route('lawyers.optimize-profile') }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    Optimize Profile
                                </a>
                            </div>
                        </div>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <h1 class="text-2xl font-bold mb-6">View other Law Service Providers</h1>
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-blue-700">
                                    Welcome to your lawyer dashboard! Use the search below to find other lawyers or law firms in the network.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="bg-white border rounded-lg overflow-hidden shadow p-4">
                            <h3 class="font-medium text-gray-700">Profile Views</h3>
                            <p class="text-2xl font-bold text-indigo-600">0</p>
                        </div>
                        <div class="bg-white border rounded-lg overflow-hidden shadow p-4">
                            <h3 class="font-medium text-gray-700">Client Inquiries</h3>
                            <p class="text-2xl font-bold text-indigo-600">0</p>
                        </div>
                        <div class="bg-white border rounded-lg overflow-hidden shadow p-4">
                            <h3 class="font-medium text-gray-700">Rating</h3>
                            <p class="text-2xl font-bold text-indigo-600">N/A</p>
                        </div>
                    </div>
                </div>
            </div>
