        ...
        <div x-show="open" 
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                @if($selectedCase && $selectedCase->contract_path)
                    ...
                    @if($selectedCase->contract_status === 'sent')
                        <div class="mt-4 border-t pt-4">
                            <div class="flex flex-col md:flex-row md:space-x-4 space-y-3 md:space-y-0">
                                <button wire:click="showSignContract({{ $selectedCase->id }})" class="inline-flex items-center justify-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                ...
                                <button wire:click="showNegotiateContract({{ $selectedCase->id }})" class="inline-flex items-center justify-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">
                                    <svg class="-ml-1 mr-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        <p class="text-sm text-purple-700">
                                            Your negotiation terms have been submitted to the lawyer. Please wait for their response.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    @if($selectedCase->contract_status === 'signed')
                        <div class="mt-4 border-t pt-4">
                                ...
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        <p class="text-sm text-green-700">
                                            You have signed this contract on {{ $selectedCase->contract_signed_at->format('M d, Y') }}. The lawyer will mark the case as active soon.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-yellow-700">
                                    No contract is available for this case yet. Your lawyer will prepare and upload it soon.
                                </p>
                            </div>
                        </div>
                    </div>
