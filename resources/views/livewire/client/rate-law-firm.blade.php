<div>
    ...
    <div x-data="{ showModal: @entangle('showRatingModal') }" 
         ...
         aria-labelledby="rate-law-firm-modal" 
         role="dialog" 
         aria-modal="true">
        ...
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-show="showModal" 
                ...
                @if($legalCase && $lawFirmId)
                <div class="sm:flex sm:items-start">
                    <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                        <h3 class="text-lg leading-6 font-medium text-gray-900" id="rate-law-firm-modal">
                            Rate Law Firm
                        </h3>
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                Please rate your experience with {{ $lawFirmName }} for this case.
                            </p>
                            <div class="mt-4">
                                <div class="mb-4">
                                    ...
                                    <p class="text-sm font-medium text-gray-700 mb-2">Law Firm: 
                                        <span class="font-semibold">
                                            {{ $lawFirmName }}
                                        </span>
                                    </p>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea id="feedback" 
                                              ...
                                              placeholder="Please share your experience with this law firm..."></textarea>
                ...
                <div class="p-4 text-center">
                    <p class="text-lg text-gray-800">No law firm found for this case.</p>
