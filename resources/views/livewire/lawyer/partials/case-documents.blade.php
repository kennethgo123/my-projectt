    ...
    <div class="flex justify-between items-center mb-4">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">
                Accepted formats: PDF, PNG, JPG (Maximum file size: 15 MB per upload)
            </p>
        </div>
        @if(!$isReadOnly ?? false)
            <button 
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="ml-3">
                                            <p class="text-sm text-blue-700">
                                                <strong>File Requirements:</strong> Only PDF, PNG, and JPG files are accepted. Maximum file size is 15 MB per upload.
                                            </p>
                                        </div>
                                    </div>
                                </div>
