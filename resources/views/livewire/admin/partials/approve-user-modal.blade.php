                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                Are you sure you want to approve this user's application? This will grant them access to the platform.
                            </p>
                            @if($selectedUser && ($selectedUser->role === 'lawyer' || $selectedUser->role === 'law_firm'))
                            <div class="mt-4">
